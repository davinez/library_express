...
// Requires the model of 'Author'
const Author = require('../models/author');
// Required for author detail page
  ...
  async.parallel(
    ...
    (err, results) => {
      ...
      if (results.author == null) {
        // No results.
        const errAuthorNotFound = new Error('Author not found');
        errAuthorNotFound.status = 404;
        return next(errAuthorNotFound);
      }
      // Successful, so render.
  ...
  async.parallel(
    ...
    (err, results) => {
      ...
      res.render('author_delete', {
        ...
        author: results.author,
        author_books: results.authors_books,
        author_books_length: results.authors_books.length,
      });
    }
  );
};
